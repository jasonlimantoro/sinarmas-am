                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-offset-1 col-md-10 col-xs-12">
                            ...
                            <tbody><tr>
                                <td width="15%" align="center"><a href="//www.sinarmas-am.co.id/download/kinerja_produk/Danamas Fleksi/Grafik Buat Web (Danamas Fleksi) - YTD.pdf" target="_blank"><?php echo gettext('Kinerja Year to Date'); ?></a></td>
                                <td width="15%" align="center"><a href="//www.sinarmas-am.co.id/download/kinerja_produk/Danamas Fleksi/Grafik Buat Web (Danamas Fleksi) - 1 Bulan.pdf" target="_blank"><?php echo gettext('Kinerja 1 Bulan'); ?></a></td>
                                <td width="15%" align="center"><a href="//www.sinarmas-am.co.id/download/kinerja_produk/Danamas Fleksi/Grafik Buat Web (Danamas Fleksi) - 3 Bulan.pdf" target="_blank"><?php echo gettext('Kinerja 3 Bulan'); ?></a></td>
                                <td width="15%" align="center"><a href="//www.sinarmas-am.co.id/download/kinerja_produk/Danamas Fleksi/Grafik Buat Web (Danamas Fleksi) - 6 Bulan.pdf" target="_blank"><?php echo gettext('Kinerja 6 Bulan'); ?></a></td>
                                <td width="15%" align="center"><a href="//www.sinarmas-am.co.id/download/kinerja_produk/Danamas Fleksi/Grafik Buat Web (Danamas Fleksi) - 1 Tahun.pdf" target="_blank"><?php echo gettext('Kinerja 1 Tahun'); ?></a></td>
                            </tr>
                            </tbody></table>
                            <h5>NAB</h5>
