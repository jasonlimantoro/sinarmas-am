                    ...
                    <div class="row">
                        <div class="col-md-offset-1 col-md-10 col-xs-12">
                            ...
                            <tr>
                                ...
                                <?php include("form/factsheet.php") ?>
                                    <input type="hidden" name="product_type" value="SMTP10">
                                </form></td>
                            </tr>
                            </tbody></table>
                        ...
                        <h5><?php echo gettext('KEBIJAKAN INVESTASI'); ?></h5>
                            ...
                            <tbody><tr>
                                ...
                                <td width="57%" valign="top" >23 Mei 2017</td>
                            </tr><tr>
                                <td valign="top" >b.</td>
