    ...
    <table width="100%" border="0" style="line-height:3px; margin-top:5px;">
      ...
      <tr>
        ...
        <?php include("form/factsheet.php") ?>
            <input type="hidden" name="product_type" value="SMTPSG5">
          </form></td>
      </tr>
    </tbody></table>
...
<!--END KINERJA SCRIPT-->
    ...
    <?php include("form/nab.php");?>
      <input name="kode_saham" type="hidden" value="142">
      <input name="product_name" type="hidden" value="Simas Gemilang 5">
      
    </form>

    <h5><?php echo gettext('TUJUAN INVESTASI'); ?></h5>
    <p>Simas Gemilang 5 <?php echo gettext('bertujuan untuk memberikan proteksi sebesar 100% (seratus persen) terhadap Pokok Investasi atas Unit Penyertaan pada Tanggal Jatuh Tempo dan memberikan potensi tambahan hasil investasi pada Tanggal Pembagian Hasil Investasi melalui investasi pada Efek Bersifat Utang yang diterbitkan oleh Pemerintah Republik Indonesia dan/atau korporasi berbadan hukum Indonesia yang telah dijual dalam Penawaran Umum dan/atau diperdagangkan di Bursa Efek Indonesia yang telah diperingkat oleh perusahaan pemerintah Efek yang terdaftar di OJK dan masuk dalam kategori layak investasi (investment grade) dan instrumen pasar uang dalam negeri dan/atau deposito, sesuai dengan peraturan perundang-undangan yang berlaku di Indonesia.'); ?></p>
    <h5><?php echo gettext('KEBIJAKAN INVESTASI'); ?></h5>
    <p>Simas Gemilang 5 <?php echo gettext('akan berinvestasi sampai dengan Tanggal Pelunasan Akhir dengan komposisi portofolio investasi'); ?> : </p>
    <ul>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tbody><tr>
        ...
        <td width="57%" valign="top" >22 <?php echo gettext('Desember'); ?> 2016</td>
      </tr><tr>
        <td valign="top" >b.</td>
