                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-offset-1 col-md-10 col-xs-12">
                            ...
                            <tbody><tr>
                                <td align="center"><a href="//www.sinarmas-am.co.id/download/kinerja_produk/Simas Satu Prima/Grafik Buat Web (Simas Satu Prima) - YTD.pdf" target="_blank"><?php echo gettext('Kinerja Year to Date'); ?></a></td>
                                <td align="center"><a href="//www.sinarmas-am.co.id/download/kinerja_produk/Simas Satu Prima/Grafik Buat Web (Simas Satu Prima) - Sejak Peluncuran.pdf" target="_blank"><?php echo gettext('Kinerja Sejak Peluncuran'); ?></a></td>
                                <td align="center"><a href="//www.sinarmas-am.co.id/download/kinerja_produk/Simas Satu Prima/Grafik Buat Web (Simas Satu Prima) - 1 Bulan.pdf" target="_blank"><?php echo gettext('Kinerja 1 Bulan'); ?></a></td>
                                <td align="center"><a href="//www.sinarmas-am.co.id/download/kinerja_produk/Simas Satu Prima/Grafik Buat Web (Simas Satu Prima) - 3 Bulan.pdf" target="_blank"><?php echo gettext('Kinerja 3 Bulan'); ?></a></td>
                                <td align="center"><a href="//www.sinarmas-am.co.id/download/kinerja_produk/Simas Satu Prima/Grafik Buat Web (Simas Satu Prima) - 6 Bulan.pdf" target="_blank"><?php echo gettext('Kinerja 6 Bulan'); ?></a></td>
                            </tr>
                            </tbody></table>
