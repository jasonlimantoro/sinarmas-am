    ...
    <table width="100%" border="0" style="line-height:3px; margin-top:5px;">
      ...
      <tr>
        ...
        <?php include("form/factsheet.php") ?>
            <input type="hidden" name="product_type" value="SMTPSG6">
          </form></td>
      </tr>
    </tbody></table>
...
<!--END KINERJA SCRIPT-->
    ...
    <?php include("form/nab.php");?>
      <input name="kode_saham" type="hidden" value="146">
      <input name="product_name" type="hidden" value="Simas Gemilang 6">

      
    </form>

    <h5><?php echo gettext('TUJUAN INVESTASI'); ?></h5>
    <p>Simas Gemilang 6 <?php echo gettext('bertujuan untuk memberikan proteksi sebesar 100% (seratus persen) terhadap Pokok Investasi atas Unit Penyertaan yang akan dicapai secara keseluruhan pada Tanggal Pelunasan Akhir dan memberikan potensi tambahan hasil investasi pada tanggal dilakukannya pembagian Hasil Investasi melalui investasi pada Efek Bersifat Utang yang diterbitkan oleh Pemerintah Republik Indonesia dan/atau korporasi berbadan hukum Indonesia yang telah diperingkat oleh perusahaan pemeringkat Efek yang terdaftar di OJK dan masuk dalam kategori layak investasi (investment grade) dan instrumen pasar uang dalam negeri dan/atau deposito, sesuai dengan peraturan perundang-undangan yang berlaku di Indonesia.'); ?> </p>
    <h5><?php echo gettext('KEBIJAKAN INVESTASI'); ?></h5>
    <p>Simas Gemilang 6 <?php echo gettext('akan berinvestasi sampai dengan Tanggal Pelunasan Akhir dengan komposisi portofolio investasi'); ?> : </p>
    <ul>
		...
		<li><?php echo gettext('Minimum 2% (dua persen) dan maksimum 20% (dua puluh persen) dari Nilai Aktiva Bersih pada instrumen pasar uang dalam negeri dan/atau deposito, sesuai dengan peraturan perundang-undangan yang berlaku di Indonesia.'); ?></li>
    </ul>
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tbody><tr>
        <td width="3%" height="21" valign="top" >a.</td>
        <td width="38%" valign="top" ><?php echo gettext('Tanggal Peluncuran'); ?></td>
        <td width="2%" valign="top" >:</td>
        <td width="57%" valign="top" >28 <?php echo gettext('Februari'); ?> 2017</td>
      </tr><tr>
        <td valign="top" >b.</td>
      ...
      <!--<tr>
        ...
        <td valign="top" >:</td>
        <td valign="top" >- Impack Pratama <br />
          (A Rating by Pefindo)<br />
          - Tiphone Mobile Indonesia <br />(A Rating by Pefindo)
