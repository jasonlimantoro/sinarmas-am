                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-offset-1 col-md-10 col-xs-12">
                            ...
                            <tr>
                                ...
                                <?php include("form/factsheet.php") ?>
                                    <input type="hidden" name="product_type" value="SMTPSG7">
                                </form></td>
                            </tr>
                            </tbody></table>
                        ...
                        <!--END KINERJA SCRIPT-->
                            ...
                            <input name="kode_saham" type="hidden" value="148">
                            <input name="product_name" type="hidden" value="Simas Gemilang 7">
                            </form>

                            <h5><?php echo gettext('TUJUAN INVESTASI'); ?></h5>
                            <p>Simas Gemilang 7 <?php echo gettext('bertujuan untuk memberikan proteksi sebesar 100% (seratus persen) terhadap Pokok Investasi atas Unit Penyertaan yang akan dicapai secara keseluruhan pada Tanggal Pelunasan Akhir dan memberikan potensi tambahan hasil investasi pada tanggal dilakukannya pembagian Hasil Investasi melalui investasi pada Efek Bersifat Utang yang diterbitkan oleh Pemerintah Republik Indonesia dan/atau korporasi berbadan hukum Indonesia yang telah diperingkat oleh perusahaan pemeringkat Efek yang terdaftar di OJK dan masuk dalam kategori layak investasi (investment grade) dan instrumen pasar uang dalam negeri dan/atau deposito, sesuai dengan peraturan perundang-undangan yang berlaku di Indonesia.'); ?></p>
                            <h5><?php echo gettext('KEBIJAKAN INVESTASI'); ?></h5>
                            <p>Simas Gemilang 7 <?php echo gettext('akan berinvestasi sampai dengan Tanggal Pelunasan Akhir dengan komposisi portofolio investasi'); ?> : </p>
                            <ul>
                            ...
                            <tbody><tr>
                                ...
                                <td width="57%" valign="top" >09 <?php echo gettext('Mei'); ?> 2017</td>
                            </tr><tr>
                                <td valign="top" >b.</td>
