            ...
            <div class="content">
                <div class="container">
                    <div class="row">
                        ...
                        -->        <td align="center"><a href="//www.sinarmas-am.co.id/download/kinerja_produk/Simas Syariah Unggulan/Grafik Buat Web (Simas Syariah Unggulan) - Sejak Peluncuran.pdf" target="_blank"><?php echo gettext('Kinerja Sejak Peluncuran'); ?></a></td>
                                <td align="center"><a href="//www.sinarmas-am.co.id/download/kinerja_produk/Simas Syariah Unggulan/Grafik Buat Web (Simas Syariah Unggulan) - 1 Bulan.pdf" target="_blank"><?php echo gettext('Kinerja 1 Bulan'); ?></a></td>
                                <td align="center"><a href="//www.sinarmas-am.co.id/download/kinerja_produk/Simas Syariah Unggulan/Grafik Buat Web (Simas Syariah Unggulan) - 3 Bulan.pdf" target="_blank"><?php echo gettext('Kinerja 3 Bulan'); ?></a></td>
                                <td align="center"><a href="//www.sinarmas-am.co.id/download/kinerja_produk/Simas Syariah Unggulan/Grafik Buat Web (Simas Syariah Unggulan) - 6 Bulan.pdf" target="_blank">Kinerja 6 Bulan</a></td>
                                <td align="center"><a href="//www.sinarmas-am.co.id/download/kinerja_produk/Simas Syariah Unggulan/Grafik Buat Web (Simas Syariah Unggulan) - YTD.pdf" target="_blank"><?php echo gettext('Kinerja Year to Date'); ?></a></td>
